(function() {
    ...
    // Marketing Instagram Subscribers Chart
    ...
    // POS System Salen Analytics Chart
    ...
    // Hotel Rooms Availabiliity Chart
    const hotelRoomsAvailabiliityChart = document.getElementById("hotelRoomsAvailabiliityChart");
    if (hotelRoomsAvailabiliityChart) {
        var options = {
            series: [72.5],
            chart: {
                height: 424,
        ...
        var chart = new ApexCharts(document.querySelector("#hotelRoomsAvailabiliityChart"), options);
        chart.render();
    }
