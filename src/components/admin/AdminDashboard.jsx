            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[25px] mb-[25px]">
                ...
                <div className="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                    <div className="trezo-card-content relative">
                        ...
                        <h5 className="mb-0 mt-[3px] text-[20px]">
                            $32,420
                        </h5>
                        ...
                        <div className="trezo-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
                            ...
                            <div className="trezo-card-subtitle">
                                <div className="trezo-card-dropdown relative">
                                    <button type="button" className="trezo-card-dropdown-btn inline-block rounded-md border border-gray-100 py-[5px] md:py-[6.5px] px-[12px] md:px-[19px] transition-all hover:bg-gray-50 dark:border-[#172036] dark:hover:bg-[#0a0e19]" id="dropdownToggleBtn">
                        ...
                        <div className="trezo-card-content">
                            ...
                            <ul className="mt-[17px] grid grid-cols-3 gap-[25px]">
                                <li>
                                    ...
                                    <h6 className="mb-0 leading-none text-lg font-medium">
                                        320
                                    </h6>
                                </li>
                                <li>
                ...
                <div className="lg:col-span-1">
                    ...
                    <div className="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                        <div className="trezo-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
                            ...
                            <div className="trezo-card-subtitle">
                                <div className="trezo-card-dropdown relative">
                                    <button type="button" className="trezo-card-dropdown-btn inline-block transition-all hover:text-primary-500" id="dropdownToggleBtn">
                                        <span className="inline-block relative ltr:pr-[17px] ltr:md:pr-[20px] rtl:pl-[17px] rtl:ml:pr-[20px]">
                                            This Week
                                            <i className="ri-arrow-down-s-line text-lg absolute ltr:-right-[3px] rtl:-left-[3px] top-1/2 -translate-y-1/2"></i>
                                        </span>
                                    ...
                                    <tbody className="text-black dark:text-white">
                                        <tr>
                                            ...
                                            <td className="ltr:text-right rtl:text-left whitespace-nowrap px-[20px] py-[17px] border-b border-gray-100 dark:border-[#172036] ltr:first:pl-0 ltr:last:pr-0 rtl:first:pr-0 rtl:last:pl-0">
                                                <a href="javascript:void(0);" className="inline-block relative w-[36px] h-[36px] text-center text-gray-500 dark:text-gray-400 transition-all border border-gray-100 dark:border-[#172036] rounded-full hover:bg-primary-500 hover:border-primary-500 hover:text-white">
                                        ...
                                        <tr>
                                            ...
                                            <td className="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]">
                                                <div className="flex items-center gap-[9px]">
                                                    <button type="button" className="text-primary-500 leading-none custom-tooltip" id="customTooltip" data-text="View">
                                                        <i className="material-symbols-outlined !text-md">
                                                            visibility
                                                        </i>
                                                    </button>
                                                    <button type="button" className="text-gray-500 dark:text-gray-400 leading-none custom-tooltip" id="customTooltip" data-text="Edit">
                                                        <i className="material-symbols-outlined !text-md">
                                                            edit
                                                        </i>
                                                    </button>
                                                    <button type="button" className="text-danger-500 leading-none custom-tooltip" id="customTooltip" data-text="Delete">
                                                        <i className="material-symbols-outlined !text-md">
                                                            delete
                                                        </i>
                                                    </button>
                            ...
                            <ul>
                                <li className="flex items-center justify-between border-b border-gray-100 dark:border-[#172036] pb-[14px] mb-[15px] last:mb-0 last:pb-0 last:border-0">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <a href="product-details.html" className="block mb-[2px] text-black dark:text-white font-medium transition-all hover:text-primary-500">
                                                Samsung Galaxy
                                            </a>
                                            <span className="block">
                                                Samsung
                                ...
                                <li className="flex items-center justify-between border-b border-gray-100 dark:border-[#172036] pb-[14px] mb-[15px] last:mb-0 last:pb-0 last:border-0">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <a href="product-details.html" className="block mb-[2px] text-black dark:text-white font-medium transition-all hvoer:text-primary-500">
                                                iPhone 15 Plus
                                            </a>
                                            <span className="block">
                                                Apple inc.
