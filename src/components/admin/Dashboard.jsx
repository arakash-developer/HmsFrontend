                            ...
                            <ul>
                                <li class="flex items-center justify-between border-b border-gray-100 dark:border-[#172036] pb-[14px] mb-[15px] last:mb-0 last:pb-0 last:border-0">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <a href="product-details.html" class="block mb-[2px] text-black dark:text-white font-medium transition-all hover:text-primary-500">
                                                Samsung Galaxy
                                            </a>
                                            <span class="block">
                                                Samsung
                                ...
                                <li class="flex items-center justify-between border-b border-gray-100 dark:border-[#172036] pb-[14px] mb-[15px] last:mb-0 last:pb-0 last:border-0">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <a href="product-details.html" class="block mb-[2px] text-black dark:text-white font-medium transition-all hvoer:text-primary-500">
                                                iPhone 15 Plus
                                            </a>
                                            <span class="block">
                                                Apple inc.
